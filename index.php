    ...
    <section class="categories">
        <div class="container">
            <h2 class="text-center">Explore Various Food Restaurants</h2>
            <?php 
                //Create SQL Query to Display restaurant from Database
                $sql = "SELECT * FROM tbl_restaurant ORDER BY id DESC LIMIT 6";
                //Execute the Query
                $res = mysqli_query($conn, $sql);
                //Count rows to check whether the restaurant is available or not
                ...
                if($count>0)
                {
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <a href="<?php echo SITEURL; ?>restaurant-foods.php?restaurant_id=<?php echo $id;?>">
                ...
                else
                {
                    ...
                    echo "<div class='error'>Restaurant not Added.</div>";
                }
            ?>
